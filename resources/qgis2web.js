...
map.getView().fit([-3319233.010397, -3671956.876676, 10486151.262855, 7809999.387744], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">vi trí sân bay của Hồ Thái Bảo Hưng </h2>';
        return titleElement;
    })(),
